...
class GCPBigQueryService:
    ...
    def upload_dataframe_to_table(
        ...
        table_id: str,
        if_exists: str = "fail",
        schema_updates: Optional[List[Dict[str, Any]]] = None,
    ) -> bool:
        """
        ...
        try:
            ...
            else:  # Default is 'fail'
                job_config.write_disposition = bigquery.WriteDisposition.WRITE_EMPTY

            # Auto-detect schema unless schema updates provided
            if schema_updates:
                schema = []
            ...
            # Get table after upload to verify row count
            table = self.client.get_table(table_ref)
            logger.info(f"Uploaded {table.num_rows} rows to {table_ref}")
