...
class GoogleChatAlert:
    ...
    def __init__(self, webhook_url=None, logo_url=None, project_id=None, dag_id=None):
        ...
        self.status_config = {
            "started": {
                "icon": "🚀",
                "title": "Modified IoU Started",
                "message": "Modified IoU candidate generation has started",
            },
            "success": {
                "icon": "✅",
                "title": "Modified IoU Completed",
                "message": "Modified IoU candidate generation completed successfully",
            },
            "failed": {
                "icon": "❌",
                "title": "Modified IoU Failed",
                "message": "Modified IoU candidate generation failed",
            },
            "progress": {
                "icon": "⏳",
                "title": "Modified IoU Progress",
                "message": "Modified IoU candidate generation stage completed",
            },
        }
            ...
            "cards": [
                {
                    "header": {
                        ...
                        "subtitle": f"Candidate Generation - Modified IoU",
