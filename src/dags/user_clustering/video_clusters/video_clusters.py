...
with DAG(
    ...
    cluster_videos = DataprocSubmitJobOperator(
        ...
        job={
            ...
            "pyspark_job": {
                "main_python_file_uri": "file:///home/dataproc/recommendation-engine/src/transform/user_clustering/get_video_clusters.py",
                "properties": {
                    ...
                    # Safe additions that won't break scripts
                    "spark.dynamicAllocation.maxExecutors": "6",  # Safe: just limits resource usage
                    "spark.executor.memory": "4g",  # Safe: only affects executor memory allocation
                    "spark.driver.memory": "4g",  # Safe: only affects driver memory allocation
                },
            },
